...
//      Change SIC code
    ...
    Scenario("Submit a refund request for Germany", Local) {
      ...
      AddVATRegistration.verifyPageTitle(AddVATRegistration.pageTitle)
      AddVATRegistration.continueAsYes()
      SupplierVATRegistrationNumber.verifyPageTitle(SupplierVATRegistrationNumber.pageTitle)
      SupplierVATRegistrationNumber.submitSupplierVATRegistrationNumber("0123456789")
