...
class NewEuvatClaimSpec
  ...
  Feature("Make a new EUVAT claim - New claim") {
    Scenario("Submit a refund request", Local) {
      ...
      SeoncdBusinessActivity.verifyPageTitle(SeoncdBusinessActivity.pageTitle)
      SeoncdBusinessActivity.selectSecondBusinessActivityCode("47110 (Retail sale in non-specialised stores)")
      ...
      SeoncdBusinessActivity.verifyPageTitle(SeoncdBusinessActivity.pageTitle)
      SeoncdBusinessActivity.selectSecondBusinessActivityCode("11010 (Manufacture of beverages)")
      AddSecondBusinessActivity.verifyPageTitle(AddSecondBusinessActivity.pageTitle)
      ...
      AddBusinessActivity.continueAsYes()
      SeoncdBusinessActivity.verifyPageTitle(SeoncdBusinessActivity.pageTitle)
      SeoncdBusinessActivity.selectSecondBusinessActivityCode("45320 (Wholesale of motor vehicle parts)")
      AddSecondBusinessActivity.verifyPageTitle(AddSecondBusinessActivity.pageTitle)
      AddSecondBusinessActivity.continueAsYes()
      ThirdBusinessActivity.verifyPageTitle(ThirdBusinessActivity.pageTitle)
      ThirdBusinessActivity.selectThirdBusinessActivityCode("25344 (Growing of fibre crops)")
      ...
      SeoncdBusinessActivity.verifyPageTitle(SeoncdBusinessActivity.pageTitle)
      SeoncdBusinessActivity.selectSecondBusinessActivityCode("45200 (Repair of motor vehicles)")
      AddThirdBusinessActivity.verifyPageTitle(AddThirdBusinessActivity.pageTitle)
      ...
      AddSecondBusinessActivity.continueAsYes()
      ThirdBusinessActivity.verifyPageTitle(ThirdBusinessActivity.pageTitle)
      ThirdBusinessActivity.selectThirdBusinessActivityCode("11010 (Manufacture of beverages)")
      AddThirdBusinessActivity.verifyPageTitle(AddThirdBusinessActivity.pageTitle)
      AddThirdBusinessActivity.clickLink("Change business activity code three")
      ThirdBusinessActivity.verifyPageTitle(ThirdBusinessActivity.pageTitle)
      ThirdBusinessActivity.selectThirdBusinessActivityCode("45320 (Wholesale of motor vehicle parts)")
      AddThirdBusinessActivity.verifyPageTitle(AddThirdBusinessActivity.pageTitle)
      ...
      AddSecondBusinessActivity.continueAsYes()
      ThirdBusinessActivity.verifyPageTitle(ThirdBusinessActivity.pageTitle)
      ThirdBusinessActivity.selectThirdBusinessActivityCode("47110 (Retail sale in non-specialised stores)")
      AddThirdBusinessActivity.verifyPageTitle(AddThirdBusinessActivity.pageTitle)
