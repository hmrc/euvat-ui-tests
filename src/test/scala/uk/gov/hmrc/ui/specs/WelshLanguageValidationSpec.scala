...
//      WelshPageVerifier.verify("RA2.2", PurchaseType)
      ...
      PurchaseTypeFood.clickByXpath("/html/body/header/section/div/nav/ul/li[2]/a")
      PurchaseTypeFood.continue()
//      WelshPageVerifier.verify("RA2.3", FoodDrink)
      PurchaseTypeFood.clickByXpath("/html/body/header/section/div/nav/ul/li[1]/a")
      ...
      PurchaseSubCategoryFood.clickByXpath("/html/body/header/section/div/nav/ul/li[2]/a")
      PurchaseSubCategoryFood.continue()
//      WelshPageVerifier.verify("RA2.4", WhoFoodDrink)
      PurchaseSubCategoryFood.clickByXpath("/html/body/header/section/div/nav/ul/li[1]/a")
